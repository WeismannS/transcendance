  ...
  const platformNews = [
    {
      ...
      summary: "Compete in our newest tournament format with rotating champions",
      time: "2 days ago",
    },
    {
      id: 2,
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <div className="mb-8">
              ...
              <p className="text-xl text-gray-300">Ready to dominate the table today?</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              ...
              {/* Win Streak */}
              <div className="bg-gray-800/50 backdrop-blur-lg border border-gray-700 rounded-2xl p-6 text-center">
                <div className="text-3xl font-bold text-green-400 mb-2">🔥 {user.winStreak}</div>
                    ...
                    {recentMatches.map((match) => (
                      ...
                      >
                        ...
                        <div className="text-right">
                          <div className="text-orange-400 font-semibold">+{match.xpGained} XP</div>
                        ...
                        >
                          ...
                          <div className="flex-1">
                            <div className="text-white">
                              <span className="font-semibold">{activity.friend}</span> {activity.action}
                            </div>
                    ...
                    <div className="space-y-4">
                      {platformNews.map((news) => (
                        ...
                        >
                          ...
                          <div className="text-gray-400 text-xs">{news.time}</div>
                        </div>
                      ))}
                    </div>
                  )}
                ...
                <div className="bg-gray-800/50 backdrop-blur-lg border border-gray-700 rounded-2xl p-6">
                  ...
                  <div className="space-y-4">
                    {upcomingTournaments.map((tournament) => (
                      <div key={tournament.id} className="p-4 bg-gray-700/30 rounded-xl">
                        <h4 className="text-white font-semibold mb-2">{tournament.name}</h4>
                        <div className="space-y-1 text-sm">
                          <div className="flex justify-between text-gray-300">
                            <span>Starts in:</span>
                            <span className="text-orange-400">{tournament.startTime}</span>
                          </div>
                          <div className="flex justify-between text-gray-300">
                            <span>Players:</span>
                ...
                <div className="bg-gray-800/50 backdrop-blur-lg border border-gray-700 rounded-2xl p-6">
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between">
                      ...
                      <span className="text-green-400 font-semibold">{user.wins}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-400">Total Losses:</span>
                      <span className="text-red-400 font-semibold">{user.losses}</span>
                    </div>
                    <div className="flex justify-between">
